...
import vid2 from '../assets/vids/vid1.mp4'
function Home() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const currentScrollPosition = window.scrollX || window.pageXOffset;
      setScrollPosition(currentScrollPosition);
    let height=  (currentScrollPosition / viewportHeight) * 100;
   height=Math.round(height);
HuziGet(height)
    };
function HuziGet(height) {
  // console.log(height)
   if (height<200) {
      if(SetVid1){
         console.log('vid 1 selected')
      }
      else{
      SetVid1=true;
      SetVid2=false;
